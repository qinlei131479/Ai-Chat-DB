...
<h3 align="center">Ai-Chat-DB - 大模型数据助手</h3>
...
Ai-Chat-DB 基于 **LangChain/LangGraph** 框架，结合 **MCP Skills** 多智能体协作架构，实现自然语言到数据洞察的端到端转换。
...
- **API 网关层**：基于 Fastapi 的高性能异步 API 服务，提供 RESTful 接口和 JWT 认证
...
**后端**：Fastapi · SQLAlchemy · LangChain/LangGraph · Neo4j · FAISS/Chroma · MinIO
